...
fn main() {
    ...
    if proto_files.is_empty() {
        println!("cargo:warning=CRITICAL: No proto files found in {}. Did you clone the repository?", proto_dir.display());
    } else {
        println!("cargo:warning=Compiling {} proto files into src/adapters/futu/protocol/generated", proto_files.len());
