    ...
    match lang {
        Language::ZhCn => DisplayDictionary {
            ...
            reasons: ReasonDictionary {
                ...
                state_cruise_restrained: "趋势延续，观察持续性".to_string(),
        ...
        Language::EnUs => DisplayDictionary {
            ...
            reasons: ReasonDictionary {
                ...
                state_cruise_restrained: "Trend continuing, observe continuity".to_string(),
        ...
        Language::JaJp => DisplayDictionary {
            ...
            decision: DecisionDictionary {
                ...
                no_trade_rule: "あらゆる能動売買はシステム規律違反となる。".to_string(),
            ...
            reasons: ReasonDictionary {
                ...
                position_none_no_trigger: "いかなる終了条件も未発動。".to_string(),
                ...
                state_cruise_restrained: "巡航中：継続性確認".to_string(),
