...
pub struct TransitionEvidenceDictionary {
    ...
    pub participation_gate_change: String,
    ...
    pub new_blockers: String,
    pub resolved_conditions: String,
    pub persisting_blockers: String,
}
    ...
    match lang {
        Language::ZhCn => DisplayDictionary {
            ...
            trend_cohesion: TrendCohesionDictionary {
                ...
                unmet: TrendCohesionGateUnmetDictionary {
                    ...
                    continuity_threshold: "核心资产持续性不足 (当前: {} 天)".to_string(),
            ...
            transition_evidence: TransitionEvidenceDictionary {
                ...
                participation_gate_change: "参与门槛状态".to_string(),
                ...
                new_blockers: "新增阻碍因素".to_string(),
                resolved_conditions: "已修复条件".to_string(),
                persisting_blockers: "持续阻碍因素".to_string(),
            },
        },
        Language::EnUs => DisplayDictionary {
            ...
            transition_evidence: TransitionEvidenceDictionary {
                ...
                participation_gate_change: "Participation Gate".to_string(),
                ...
                new_blockers: "New Blockers".to_string(),
                resolved_conditions: "Resolved Conditions".to_string(),
                persisting_blockers: "Persisting Blockers".to_string(),
            },
        },
        Language::JaJp => DisplayDictionary {
            ...
            transition_evidence: TransitionEvidenceDictionary {
                ...
                participation_gate_change: "参加ゲート状態".to_string(),
                ...
                new_blockers: "新規阻害要因".to_string(),
                resolved_conditions: "解消された条件".to_string(),
                persisting_blockers: "継続中の阻害要因".to_string(),
            },
        },
    }
}
