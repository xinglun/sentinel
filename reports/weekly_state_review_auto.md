...
- Event Fact: Jet financiers fret as Iran war pumps up fuel and borrowing costs - Reuters; Jet financiers fret as Iran war pumps up fuel and borrowing costs  Reuters
...
- exceptionalFactors: []
- Narrative:
  - 当前综合排序领先为 UNAVAILABLE；支持结构为 UNAVAILABLE。当前突破观察: PLTR (突破萌芽（第1天）), U (突破萌芽（第2天）)，整体属于当前截面观察。
  ...
  - 短期相对强度开始在 ISRG / GOOG 等个别资产恢复，尚不足以构成新的 Leadership。
  - 相对强度在 NVDA / TSLA 等资产出现初步改善，但尚不足以确认恢复。
  - RS Recovery Breadth：4/9 非基准资产改善；Strong/Moderate Recovery：2/9 强/中等恢复；RS Diffusion：EMERGING。Actionable Diffusion：NOT_CONFIRMED
...
- Leader Persistence:
  ...
  - Leader Absence Since: 2026-09-02
  - Tactical Leadership Structure: LEADERLESS / FRAGMENTED
  - 连续领导天数: 0 天
  - 领导评分: 0.0
  - 领导状态: ABSENT
